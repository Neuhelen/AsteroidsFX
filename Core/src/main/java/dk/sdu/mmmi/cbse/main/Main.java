...
public class Main extends Application {
    ...
    public static void main(String[] args) {
        layer = createLayer(System.getProperty("user.dir") + "/mods-mvn/", "Asteroid");
        layer = createLayer(System.getProperty("user.dir") + "/mods-mvn/", "Player");
        /*while(layer.modules().iterator().hasNext()){
            System.out.println(layer.modules().iterator().next());
        }*/

        var services = ServiceLoader.load(layer, ISplitPackage.class);
        services.stream()
                .map(ServiceLoader.Provider::get)
                .forEach(SplitPackage ->
                        System.out.println(SplitPackage.provide())
                );
